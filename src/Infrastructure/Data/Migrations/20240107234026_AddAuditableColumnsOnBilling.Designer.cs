...
namespace MyApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240107234026_AddAuditableColumnsOnBilling")]
    partial class AddAuditableColumnsOnBilling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.DiscountPolicy.DiscountPolicyBase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("516a94ba-222f-4ce1-8f7b-d7e5ae1c7b06"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(113), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 1,
                            DiscountType = 1,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("cf437721-aa32-423a-806f-55a40e573345"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(170), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 1,
                            DiscountType = 1,
                            DiscountUnit = 1,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("030ad149-ada1-4365-9acb-7648c648a338"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(173), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 1,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("1d3c88bb-0ce6-4224-a9b7-d3b12f092f10"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(176), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 1,
                            DiscountUnit = 1,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("177f3aca-06ed-420d-8b2d-a017ba832cc0"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(179), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 2,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("88437a47-68a9-4e4b-af37-ab7a0ea8ff5f"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 0, 40, 26, 741, DateTimeKind.Unspecified).AddTicks(182), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 2,
                            DiscountUnit = 1,
                            IsDeleted = false,
