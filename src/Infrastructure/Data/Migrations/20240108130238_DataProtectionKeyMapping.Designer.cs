...
namespace MyApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240108130238_DataProtectionKeyMapping")]
    partial class DataProtectionKeyMapping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.DiscountPolicy.DiscountPolicyBase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2baa7800-ffeb-4318-8b1d-e1c3f1693c2a"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(789), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 1,
                            DiscountType = 1,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("a8ce8539-0723-42c7-bc4d-5fa266efe2f6"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(839), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 1,
                            DiscountType = 1,
                            DiscountUnit = 1,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("4920f12a-9daa-425f-8517-97310c4980c7"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(842), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 1,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("66ef26ae-fee6-4b12-8124-dda82b9128ed"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(844), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 1,
                            DiscountUnit = 1,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("a5cf6105-a793-4776-9899-b31abd985424"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(847), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 2,
                            DiscountUnit = 2,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("60138b79-d7f6-45bc-a9fc-d6857d307e00"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 1, 8, 14, 2, 38, 33, DateTimeKind.Unspecified).AddTicks(849), new TimeSpan(0, 1, 0, 0, 0)),
                            CustomerType = 2,
                            DiscountType = 2,
                            DiscountUnit = 1,
                            IsDeleted = false,
