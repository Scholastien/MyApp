...
public class DiscountController: BaseControllerApp
{
    ...
    public DiscountController(UserManager<IdentityUserBase> userManager, SignInManager<IdentityUserBase> signInManager, ILogger<DiscountController> logger, AppDbContext dbContext, IDiscountPolicyService discountPolicyService) : base(userManager, signInManager, logger, dbContext)
    {
    ...
    [HttpPost]
    public async Task<ActionResult> Add([FromForm] DiscountPolicyEditReq<DiscountPolicyDto<DiscountPolicyBase>, DiscountPolicyBase> req)
    {
